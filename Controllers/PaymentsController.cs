...
namespace VehicleTax.Web.Controllers
{
    ...
    public class PaymentsController : ControllerBase
    {
        ...
        public PaymentsController(AppDbContext context, IConfiguration configuration, IPaymentReferenceService referenceService)
        {
            _context = context;
        ...
        public IActionResult CollectPreviewInvoice(int paymentId, [FromBody] CollectInvoiceDto dto)
        {
            ...
            // ✅ Assign audit Reference No. only when the payment transitions to Paid.
            //    Pending/Failed/Cancelled payments keep ReferenceNo = NULL.
            //    Generated by the backend — NEVER by the Flutter client.
            ...
            [FromQuery] bool includeChecksum = false)
        {
            ...
            var lines = new List<string>
            {
                ...
                KeyValue("RefNo", payment.ReferenceNo?.ToString() ?? "-", width),
