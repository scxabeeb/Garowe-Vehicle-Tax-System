...
public class GolisWebhookController : ControllerBase
{
    ...
    public GolisWebhookController(AppDbContext context, IOptions<GolisWebhookSettings> options, IPaymentReferenceService referenceService)
    {
        _context = context;
    ...
    public async Task<IActionResult> Post([FromBody] GolisWebhookPayload payload)
    {
        ...
        //    Generated by the backend — NEVER by the Flutter client.
