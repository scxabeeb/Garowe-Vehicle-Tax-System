        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Movements_CarTypes_CarTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaxAmounts_CarTypes_CarTypeId",
                        column: x => x.CarTypeId,
                        principalTable: "CarTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaxAmounts_Movements_MovementId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReceiptReferences_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiptReferenceId = table.Column<int>(type: "int", nullable: true),
                    IsReverted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    RevertReason = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RevertedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    RevertedByUserId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_Users_RevertedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_RevertedByUserId",
                table: "Payments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReceiptReferences_VehicleId",
                table: "ReceiptReferences",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_TaxAmounts_CarTypeId",
                table: "TaxAmounts",
                column: "CarTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_TaxAmounts_MovementId",
                table: "TaxAmounts",
                column: "MovementId");
